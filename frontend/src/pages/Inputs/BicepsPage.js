...
function BicepsPage({updateInputs, index, routes, handleRestart}) {
  ...
  const options = ["Long Head", "Short Head", "Brachialis"];
  const [choice, setChoice] = useState(new Array(options.length).fill(false));
  return (
    <>
    <div>
      <div className="div-container">
        <h2> Which region of the biceps would you like to bias?</h2>
